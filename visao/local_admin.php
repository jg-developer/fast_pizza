...
<script>
    function initMap() {
        var localizacao = <?php echo json_encode($retorno);?>;
  ...
  <section class="form-admin text-center">
    ...
    <form action="" method="POST" class="" id="form">
      <div class="form-group input-group col-lg-6 col-md-8 col-sm-10 col-xs-10 offset-lg-3 offset-md-2 offset-sm-1 offset-xs-1">
          <input type="text" class="form-control" id="endereco" name="endereco" value="<?php echo "{$retorno[0]->endereco}" ?>" placeholder="Pesquisar localização">
